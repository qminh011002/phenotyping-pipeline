...
export function ResultViewerDialogs({
    ...
    return (
        <>
            <AlertDialog open={dirtyNavDialogOpen} onOpenChange={onDirtyNavOpenChange}>
                <AlertDialogContent>
                    <AlertDialogHeader>
            ...
            <Dialog open={quitDialogOpen} onOpenChange={onQuitDialogOpenChange}>
                <DialogContent size="sm">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            You're reviewing a draft. Quit to come back to it later, or save now to
                            add it to your Records.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
            ...
            <AlertDialog open={resetDialogOpen} onOpenChange={onResetDialogOpenChange}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This will discard all annotation edits and restore the original model
                            detections. This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
