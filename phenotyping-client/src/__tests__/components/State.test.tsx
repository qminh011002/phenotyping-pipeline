...
describe('EmptyState', () => {
    ...
    it('does not render description when absent', () => {
        const { container } = render(<EmptyState icon={RefreshCw} title="No analyses yet" />);
        expect(container.querySelector('.text-sm.text-muted-foreground')).not.toBeInTheDocument();
    });
