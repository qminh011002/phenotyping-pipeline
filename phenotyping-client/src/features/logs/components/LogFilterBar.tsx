  ...
  return (
    <div className="flex flex-wrap items-center gap-2 border-b px-3 py-2">
      ...
      {LEVELS.map(({ level, label, color }) => (
        <Button
          ...
          className={cn(
            ...
            filters[level] ? color : "text-muted-foreground/40 border-transparent bg-transparent",
          )}
      ...
      <Button
        variant="ghost"
        size="sm"
        className={cn("h-6 gap-1 px-2 text-xs", autoScroll ? "text-primary" : "text-muted-foreground")}
