...
const toastClassNames: NonNullable<ToasterProps['toastOptions']>['classNames'] = {
    toast: 'group flex items-start gap-3 rounded-xl border border-border/80 bg-card p-4 text-card-foreground shadow-lg',
    content: 'min-w-0 flex-1 pr-8',
    icon: 'mt-0.5 flex size-9 shrink-0 items-center justify-center rounded-lg border border-border/70 bg-muted/70 text-muted-foreground shadow-xs',
    ...
    info: 'border-l-[3px] border-l-sky-500/80 [&_[data-icon]]:border-sky-500/20 [&_[data-icon]]:bg-sky-500/10 [&_[data-icon]]:text-sky-600 dark:[&_[data-icon]]:text-sky-300',
    warning:
    ...
    error: 'border-l-[3px] border-l-destructive/80 [&_[data-icon]]:border-destructive/20 [&_[data-icon]]:bg-destructive/10 [&_[data-icon]]:text-destructive dark:[&_[data-icon]]:text-red-300',
};
