...
const sheetSideVariants = cva(
    'fixed z-50 flex flex-col bg-background shadow-lg transition ease-in-out',
    {
        variants: {
            side: {
                right: 'inset-y-0 right-0 h-full data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right data-[state=open]:animate-in data-[state=open]:slide-in-from-right border-l',
                left: 'inset-y-0 left-0 h-full data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:animate-in data-[state=open]:slide-in-from-left border-r',
                top: 'inset-x-0 top-0 h-auto data-[state=closed]:animate-out data-[state=closed]:slide-out-to-top data-[state=open]:animate-in data-[state=open]:slide-in-from-top border-b',
                bottom: 'inset-x-0 bottom-0 h-auto data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom data-[state=open]:animate-in data-[state=open]:slide-in-from-bottom border-t',
            },
        },
        defaultVariants: {
            side: 'right',
...
function SheetFooter({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                'mt-auto flex flex-row items-center justify-end gap-2 px-6 py-4 border-t shrink-0',
                className,
            )}
            {...props}
        />
